...
class MapsDisign : Fragment(R.layout.fragment_maps_disign), OnMapReadyCallback {
    ...
    private var mapPoint: LatLng? = null
    var observer=false
    ...
    private fun backDireccion() {
        val navegacion =MapsDisignDirections.actionMapsDisignToFragmentDireccion(country, adrress, city)
